...
- ly (thinking like humans)
  - **Cognitive science** brings together computer models from AI and experimental techniques from psychology to construct **precise and testable theories** of the human mind.
  	- Ex: how to mimic the problem-solving and decision-making process of humans.
  
  Thinking rationally (thinking logically)
  - Logic is used for knowledge representation and problem-solving
  - Challenges
  	* Not all intelligence is mediated by logic (different from human thinking)
  	* What is the purpose of thinking? What thoughts should I have?
  
  Acting humanly (acting like humans) - **Turing Test**
  - If the computer wins, it is intelligent
  - To pass the test, the computer needs to have:
  	* NLP: natural language processing
  	* knowledge representation
  	* automated reasoning
  	* machine learning
  - **Total Turing Test:** Also requires *Vision* and *Robotics*
  
  Acting rationally (acting in the rational way)
  - Goals are achieved by **rational action**
  - **Rational system** does the right thing
  	* It needs to have perception
  	* very general approach, wider than strict logical approaches, and including but not subsuming human approaches.
  
  **Rational agent**
  - Takes in perceptions and choose actions that maximize its performance measure
  - Logic approach: not have knowledge about the environment in advance → acting solely based on its prior knowledge versus learning automatically via intelligence. Later, have importance to *perception and learning*.
  
  AI technique: A method that exploits knowledge that should be represented in such a way that:
  - The knowledge captures generalizations
  - It can be understood by people who must provide it
  - It can be modified to correct errors
  - It can be used in a great many situations even if it's not totally accurate or complete
  - AI searches through the solution space before making decisions.
  ...
  **Szolovits** (1982)
  ...
  Sources:
  Human introspections (from fallible)
  Psychological experiments (so difficult to measure behavior, human problem-solving)
  Solution: *Cognitive science: rationally reconstruct human problem-solving*
  
  **Newell and Simon's** (1976) Physical symbol system hypothesis
  **A physical symbol system has the necessary and sufficient means for general intelligent action.**
  
  > **Elaine Rich** (1983)
  > AI is the study of how to make computers do things at which, at the moment, people are better.
  > **Mark Fox** (1986)
  > characteristics: algorithms that allow us to achieve figments which are (1) computationally intensive, (2) require human expertise, or (3) are knowledge-based or data-intensive.
  
  ---
  
  **Who is the father of AI?** John McCarthy coined the term.
  **When was AI born?** 1956, Dartmouth conference.
  
  ---
  
  **Elaine Rich's problem with current computer systems**
  - Limited to narrow subsets of the problems people solve ex: algebra problem, prove theorems (but no scientist or mathematician)
  - Humans are able to use *analogy, similarity, memory*
  - Current AI doesn't get there yet.
  
  ---
  
  **Knowledge is necessary for intelligence**
  - **Expert systems** → first practically application, mimicked expert knowledge
  - **Common sense** → understanding of how things work in the world (SHRDLU, 1970)
  
  ---
  
  **Neats vs Scruffies** 
  - Neats: use logic and formal systems
  - Scruffies: use heuristic algorithms and AI methods like neural networks
  
  ---
  
  **Two camps in AI**
  1. Logicist approach: formalize tasks, develop efficient algorithms (knowledge lean)
  2. Scruffy approach: psychological tractability of problems (knowledge rich)
  
  ---
  
  **AI timeline**
  - Early days: search, game playing (Samuel)
  - Lisp, natural language, expert systems, speech recognition
  - Dark ages: over optimism, lack of hardware
  - Back to neural networks (AI winter)
  ...
  **Material to cover in this course**
  ...
  - Agents → building blocks for AI systems
  
  ---
  
  **Knowledge representation learning** (used in recent NLP applications, start becoming popular in 2015 with deep learning)
  - There is **no** universal knowledge representation → depends on the problem domain
  
  **Amount of knowledge** varies from full knowledge → acting rationally or just partial → acting humanly.
  
  ---
  
  **Agent (Russell and Norvig):**
  An agent is anything that can be viewed as perceiving its environment through sensors and acting upon that environment through effectors.
  
  ---
  
  Example: Mars rover
  - Agent: software module controlling the rover
  - Sensory input: cameras, position sensors
  - Output: motors, cameras, arms
  ...
  **Autonomous agent**
  An agent that uses its own experience (versus prior knowledge) to decide actions
